    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index">PT. DMM<br>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="data_kerusakan?tgl=ALL-DATA"><i class="fa fa-history fa-2x"></i> <b>Data Kerusakan</b></a>
                    </li>
                    <li >
                    ...
                    <div class="col-md-12" style="margin-bottom: 10px;">
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <h4 style="color: red;"><i class="fa fa-history"></i> DATA KERUSAKAN</h4>           
                            </div>
                            <div class="col-md-5 text-center">
                                ...
                                <form method="get">
                                    ...
                                    <select name="tgl" class="form-control" onchange="this.form.submit()">
                                         ...
                                         <?php 
                                         $sql = mysqli_query($konek,"SELECT tgl_rusak FROM tbl_kerusakan GROUP BY month(tgl_rusak) ORDER BY tgl_rusak DESC");
                                         foreach($sql as $hs){
                                            $date = explode('-', $hs['tgl_rusak']);
                                            $bln = $date[0].'-'.$date[1];
                                        ?>
                            ...
                            <div class="col-md-3 text-center">
                                <div>&nbsp;</div>
                                <button class="btn btn-primary" data-toggle="modal" data-target="#ModalTambah"><i class="fa fa-plus"></i> Tambah    
                                </button>
                                <a href="laporan_data_kerusakan?tgl=<?php echo $_GET['tgl'] ?>" target="blank" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak Pdf</a>  
                            </div>
                        </div>
                    </div>
                </div>              
                                ...
                                <table  id="dataTables-example" class="table table-striped table-bordered table-hover table-condensed">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="font-size: 12px">
                                            ...
                                            <td><?php echo tgl_indo($a['tgl_rusak']); ?></td>
                                            <td>
                                                <?php 
                                                $tr = $a['tgl_prb']; 
                                                if($tr=='0000-00-00'){
...
<a class="btn btn-xs btn-danger" onclick="confirm_delete('data_kerusakan_delete.php?id=<?php echo $a['id'];?>')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <div class="modal fade" id="ModalTambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary"  style="border-top-right-radius: 5px;border-top-left-radius: 5px;">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-history"></i> TAMBAH DATA KERUSAKAN</h4>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="tgl_kr" class="form-control" autocomplete="off" placeholder="Jenis Kerusakan" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="tgl_pb" class="form-control" autocomplete="off" placeholder="Jenis Kerusakan" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="jns_ker" class="form-control" autocomplete="off" placeholder="Jenis Kerusakan" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>STATUS</label>
    ...
    <script>
        ...
        $(".modal_edit").click(function(e) {
            var m = $(this).attr("id");
                $.ajax({
                    url: "data_kerusakan_modal_edit.php",
                    type: "GET",
                    data : {id: m,},
                    success: function (ajaxData){
